...
M.generate = function(colors)
  return {
    ...
    Todo = { fg = colors.cyan }, -- anything that needs extra attention; mostly the keywords TODO FIXME and XXX
    ...
    VistaScope = { fg = colors.dark_purple },
    VistaTag = { fg = colors.purple },
    VistaPrefix = { fg = colors.dark_purple },
    ...
    MiniStatuslineModeVisual = { bg = colors.dark_purple, fg = colors.black },
